...
@Configuration
@ComponentScan(basePackages = { "tienph.service" })
public class AppConfig {
    ...
    // vn.viettuts.mapper
    /*--
     * @Bean (name = "studentMapper") public StudentMapper studentMapper()
     * throws Exception { SqlSessionTemplate sessionTemplate = new
     * SqlSessionTemplate(sqlSessionFactory().getObject()); return
     * sessionTemplate.getMapper(StudentMapper.class); }
     */
}
